# CyberPaste Project Analysis

## 1. Project Overview
**CyberPaste** is a native Windows clipboard history manager application built with a modern stack. It runs as a desktop application with a background service to monitor clipboard changes.
